      ...
      <Collapsible.Trigger>
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <Collapsible.Chevron />
            <div>
              <div className="text-base font-semibold text-slate-900 dark:text-slate-100">Monte Carlo simulation</div>
      ...
      <Collapsible.Content>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 px-4 py-3">
            <div>
              <div className="text-sm font-medium text-slate-900 dark:text-slate-100">Enable Monte Carlo simulation</div>
            ...
            <>
              <div className={"grid gap-3"}>
                <div className="space-y-1">
                  <label className="text-xs font-medium uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">Run count</label>
                  <input
                    type="number"
                    inputMode="numeric"
                    min={1}
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">Seed (optional)</label>
                  <input
                    type="number"
                    inputMode="numeric"
                    value={seedInput}
              ...
              {isRunning && progressPct !== null ? (
                ...
                <div className="rounded-xl border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 px-4 py-3">
                  <div className="text-xs font-medium uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">How the simulation works</div>
