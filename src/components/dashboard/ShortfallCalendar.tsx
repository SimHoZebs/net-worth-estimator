					...
					<div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_16rem]">
						<div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-3">
							<Calendar
								...
								modifiersClassNames={{
									shortfall:
										"[&_button]:border [&_button]:border-amber-300 dark:[&_button]:border-amber-700 [&_button]:bg-amber-50 dark:[&_button]:bg-amber-950 [&_button]:font-semibold [&_button]:text-amber-900 dark:[&_button]:text-amber-300 [&_button]:hover:bg-amber-100 dark:[&_button]:hover:bg-amber-900/50",
								}}
						...
						<div className="space-y-3 rounded-2xl border border-amber-200 dark:border-amber-800 bg-amber-50/70 dark:bg-amber-950/70 p-4">
							<div>
								<div className="text-xs font-medium uppercase tracking-[0.16em] text-amber-800 dark:text-amber-300">
									Shortfall dates
								</div>
								<div className="mt-1 text-2xl font-semibold text-amber-950 dark:text-amber-200">
				...
				>
					...
					>
						<div className="mb-4 flex items-start justify-between gap-4">
							<div>
								<div className="text-xs font-medium uppercase tracking-[0.16em] text-amber-700 dark:text-amber-400">
									Projected shortfall
								</div>
