...
export default defineConfig({
  ...
  webServer: { command: production ? 'VITE_WAYPOINT_MODE=fixture npm run preview' : 'VITE_WAYPOINT_MODE=fixture npm run dev', url: baseURL, reuseExistingServer: !process.env.CI, timeout: 30_000 },
});
